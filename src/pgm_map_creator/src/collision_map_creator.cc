...
// FIXED: The define below is for png_dynamic_io.hpp, which otherwise doesn't find a definition for int_p_NULL. Also see https://github.com/ignf/gilviewer/issues/8
...
class CollisionMapCreator : public WorldPlugin
{
  ...
  public: void Load(physics::WorldPtr _parent, sdf::ElementPtr _sdf)
  {
    ...
    // node->Init(world->GetName()); FIXED: Melodic does not support GetName() anymore
  ...
  public: void create(CollisionMapRequestPtr &msg)
  {
    ...
    // gazebo::physics::PhysicsEnginePtr engine = world->GetPhysicsEngine();  FIXED: syntax is deprecated
